        ...
        const popupContent = `
            <div style="text-align: center; width: 220px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 5px; margin-bottom: 10px; text-align: left; background: rgba(0,0,0,0.2); padding: 5px; border-radius: 5px;">
                  ...
                  <label style="font-size: 12px; display: flex; justify-content: space-between; align-items: center;">🚑 Ambulância <input type="number" id="inc-qtd-2" min="0" max="10" value="0" style="width: 40px; background: rgba(0,0,0,0.3); color: #fff; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; text-align: center;"></label>
                </div>
